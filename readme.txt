...
First of all, you need to build the app with "go build csvParserV1.1.go".
...
For example you can parse the CSV-file, which included in this package by: "./csvParserV1.1 ./theCSV.csv all"
